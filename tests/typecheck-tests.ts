...
import { safeTry } from '../src/result'
...
(function describe(_ = 'ResultAsync') {
  ...
  (function describe(_ = 'combine') {
    ...
    (function describe(_ = 'inference on large tuples') {
      ...
      (function it(_ = 'Should correctly infer the type on tuples with arbitrarily large ') {
        type Input = [...ResultAsync<string, never>[], ResultAsync<boolean, never>]
        type Expectation = ResultAsync<[...string[], boolean], never>
